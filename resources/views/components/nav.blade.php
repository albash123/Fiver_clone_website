<x-sidebar></x-sidebar>
<div
    class="d-flex flex-column flex-md-row   col-md-10 col-11 mx-auto align-items-center justify-content-between gap-1 gap-md-3">
    <div class="d-flex gap-2 justify-content-start align-items-center align-self-start">
        <i class="bi bi-list fs-2 d-flex sidebar-btn d-lg-none"></i>
